...
{{--        <div class="card mb-4">--}}
{{--            <div class="card-body">--}}
{{--                <div class="fs-4 fw-semibold">4.13%</div>--}}
{{--                <div>826</div>--}}
{{--                <div class="progress progress-thin my-2">--}}
{{--                    <div class="progress-bar bg-danger" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>--}}
{{--                </div><small class="text-medium-emphasis">For Sale</small>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
{{--    <div class="col-sm-6 col-lg-3">--}}
{{--        <div class="card mb-4">--}}
{{--            <div class="card-body">--}}
{{--                <div class="fs-4 fw-semibold">2.83%</div>--}}
{{--                <div>566</div>--}}
{{--                <div class="progress progress-thin my-2">--}}
{{--                    <div class="progress-bar bg-success" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>--}}
{{--                </div><small class="text-medium-emphasis">For Rent</small>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
{{--    <!-- /.col-->--}}
...
{{--        <div class="card mb-4">--}}
{{--            <div class="card-body">--}}
{{--                <div class="fs-4 fw-semibold">93.04%</div>--}}
{{--                <div>18,608</div>--}}
{{--                <div class="progress progress-thin my-2">--}}
{{--                    <div class="progress-bar bg-info" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>--}}
{{--                </div><small class="text-medium-emphasis">Sold</small>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
{{--    <!-- /.col-->--}}
...
{{--        <div class="card mb-4">--}}
{{--            <div class="card-body">--}}
{{--                <div class="fs-4 fw-semibold">0.63%</div>--}}
{{--                <div>126</div>--}}
{{--                <div class="progress progress-thin my-2">--}}
{{--                    <div class="progress-bar bg-warning" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>--}}
{{--                </div><small class="text-medium-emphasis">New homes today</small>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </div>--}}
{{--    <!-- /.col-->--}}
...
<div class="row">
    <div class="col-sm-6 col-lg-3">
        <div class="card mb-4 text-white bg-primary">
            <div class="card-body">
                <div class="fs-4 fw-semibold">{{round($sell*100/$total, 2)}}%</div>
                <div>{{$sell}}</div>
                <div class="progress progress-white progress-thin my-2">
                    <div class="progress-bar" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                </div><small class="text-medium-emphasis-inverse">FOR SALE</small>
            </div>
        </div>
    </div>
    <!-- /.col-->
    <div class="col-sm-6 col-lg-3">
        <div class="card mb-4 text-white bg-warning">
            <div class="card-body">
                <div class="fs-4 fw-semibold">{{round($rent*100/$total, 2)}}%</div>
                <div>{{$rent}}</div>
                <div class="progress progress-white progress-thin my-2">
                    <div class="progress-bar" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                </div><small class="text-medium-emphasis-inverse">FOR RENT</small>
            </div>
        </div>
    </div>
    <!-- /.col-->
    <div class="col-sm-6 col-lg-3">
        <div class="card mb-4 text-white bg-danger">
            <div class="card-body">
                <div class="fs-4 fw-semibold">{{round($sold*100/$total, 2)}}%</div>
                <div>{{$sold}}</div>
                <div class="progress progress-white progress-thin my-2">
                    <div class="progress-bar" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                </div><small class="text-medium-emphasis-inverse">SOLD</small>
            </div>
        </div>
    </div>
    <!-- /.col-->
    <div class="col-sm-6 col-lg-3">
        <div class="card mb-4 text-white bg-info">
            <div class="card-body">
                ...
                <div class="progress progress-white progress-thin my-2">
                    <div class="progress-bar" role="progressbar" style="width: 25%" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                </div><small class="text-medium-emphasis-inverse">TOTAL</small>
            </div>
        </div>
    </div>
    <!-- /.col-->
