        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    @if($add_state == '')
                        <button type="button" class="btn btn-success" onclick="sending('true')" id="success" data-dismiss="modal">Save</button>
                    @else
                        <button type="button" class="btn btn-success" onclick="sending('false')" id="success" data-dismiss="modal">edit</button>
                    @endif
            ...
            $.ajax('{{ route("backend.$module_name.settings") }}', {
                ...
                success: function (data, status, xhr) {
                    if(data == 'save_success'){
                        alert('Save Prefix Words');
                    }else {
                        alert('Change Prefix Words');
                    }
                },
